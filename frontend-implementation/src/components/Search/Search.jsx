...
const Search = () => {
  return (  
    <div className='flex justify-between  '>
      <button className='border-orange-400 border-2 rounded-sm p-2 px-6 flex gap-2 '>
      ...
      <div className='flex items-center border-[1.5px] border-gray-300 rounded-sm w-3/5 p-1 gap-2'>
